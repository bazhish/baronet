# backend\sistemas\classes\classes_combatentes.py
...
from backend.sistemas.classes.habilidades_ativa_combatentes import (
...
from backend.sistemas.classes.habilidades_passiva_combatentes import (
